                ...
                {loading ? (
                    ...
                    <div className="space-y-6">
                            ...
                            {data.periods.length === 0 ? (
                                ...
                                <div className="divide-y divide-neutral-100">
                                    {data.periods.map((period) => {
                                        ...
                                        return (
                                            <div key={period.period} className="p-5">
                        ...
                        <div className="grid grid-cols-4 gap-3">
                            <button
                                onClick={() => router.push('/')}
                                className="bg-white rounded-xl p-4 border border-neutral-200 hover:shadow-md transition-all flex flex-col items-center gap-2"
                            >
                                ...
                                <span className="text-xs font-medium text-neutral-600">Pelanggan</span>
                            </button>
                            <button
                            ...
                            >
                                ...
                                <span className="text-xs font-medium text-neutral-600">Import</span>
                            </button>
                            <button
                            ...
                            >
                                ...
                                <span className="text-xs font-medium text-neutral-600">Tambah</span>
                            </button>
                            <button
                            ...
                            >
                                ...
                                <span className="text-xs font-medium text-neutral-600">Setting</span>
                            </button>
                        </div>
                    </div>
                )}
